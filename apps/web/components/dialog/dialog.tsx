...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="cursor-pointer outline-0 absolute right-4 top-4 z-30 rounded-sm text-gray-500 opacity-90 ring-offset-background transition-opacity hover:opacity-100 hover:text-gray-700 focus:outline-none disabled:pointer-events-none">
        <X className="h-4 w-4 outline-0" />
